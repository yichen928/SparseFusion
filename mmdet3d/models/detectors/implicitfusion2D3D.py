...
class ImplicitFusionDetector2D_3D(MVXTwoStageDetector):
    """Base class of Multi-modality VoxelNet."""

    def __init__(self, **kwargs):
        super(ImplicitFusionDetector2D_3D, self).__init__(**kwargs)
    ...
    def init_weights(self, pretrained=None):
        ...
        super(ImplicitFusionDetector2D_3D, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        if pts_feats:
            losses_pts = self.forward_pts_train(
                pts_feats, img_feats, gt_bboxes_3d, gt_labels_3d, gt_bboxes, gt_labels, img_metas, gt_bboxes_ignore
            )
    ...
    def forward_pts_train(self,
        ...
        loss_inputs = [gt_bboxes_3d, gt_labels_3d, gt_bboxes, gt_labels, outs]
