...
class ImplicitFusionDetector2D_3D_Cross(MVXTwoStageDetector):
    """Base class of Multi-modality VoxelNet."""

    def __init__(self, batch_scaling, **kwargs):
        super(ImplicitFusionDetector2D_3D_Cross, self).__init__(**kwargs)
    ...
    def init_weights(self, pretrained=None):
        ...
        super(ImplicitFusionDetector2D_3D_Cross, self).init_weights(pretrained)
