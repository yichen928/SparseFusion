...
from mmdet3d.models.utils import FFN, TransformerDecoderLayer, PositionEmbeddingLearned, PositionEmbeddingLearnedwoNorm,\
    PositionEmbeddingLearnedMulti, PointTransformer2D_3D, ImageTransformer2D_3D, FusionTransformer2D_3D_Fuse, \
    PointProjection, ImageProjection, ProjectionL2Norm, ProjectionLayerNorm, Projection_wPos
...
class ImplicitHead2D_3D_Fuse(nn.Module):
    def __init__(self,
                 with_pts=False,
                 with_img=False,
                 pts_smca=True,
        ...
        super(ImplicitHead2D_3D_Fuse, self).__init__()
        ...
        if with_pts and with_img:
            ...
            pts_projection = Projection_wPos(hidden_channel, fusion_query_pos)
            img_projection = Projection_wPos(hidden_channel, fusion_key_pos)
            ...
            self.fusion_transformer = FusionTransformer2D_3D_Fuse(
                ...
                test_cfg=test_cfg, pts_projection=pts_projection, img_projection=img_projection, normal_pos=normal_pos
            )
