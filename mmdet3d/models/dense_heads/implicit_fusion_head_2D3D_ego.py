...
from mmdet3d.models.utils import FFN, TransformerDecoderLayer, PositionEmbeddingLearned, PositionEmbeddingLearnedwoNorm, \
    PositionEmbeddingLearnedMulti, PointTransformer2D_3D, ImageTransformer2D_3D, FusionTransformer2D_3D, PointProjection, \
    ImageProjection, ProjectionL2Norm, ProjectionLayerNorm, ImageTransformer2D_3D_ego, PointTransformer2D_3D_ego, FusionTransformer2D_3D_ego
...
class ImplicitHead2D_3D_ego(nn.Module):
    def __init__(self,
                 with_pts=False,
                 with_img=False,
                 pts_smca=True,
        ...
        super(ImplicitHead2D_3D_ego, self).__init__()
        ...
        if with_pts:
            ...
            self.point_transformer = PointTransformer2D_3D_ego(
                ...
                test_cfg=test_cfg, query_pos=pts_query_pos_embed, key_pos=pts_key_pos_embed
            )
        if with_img:
            ...
            self.img_transformer = ImageTransformer2D_3D_ego(
        ...
        if with_pts and with_img:
            ...
            self.fusion_transformer = FusionTransformer2D_3D_ego(
