...
for bid in range(bs):
    ...
    for view_id in range(view_num):
        ...
        view_img = our_draw_lidar_bbox3d_on_img(lidar_bbox_3d, view_img, lidar2img_rt, img_metas[bid], view_id=view_id, inverse_aug=False)
        # view_img = our_draw_lidar_bbox3d_on_img(lidar_bbox_3d, view_img, img_metas[bid]['lidar2img'][view_id], img_metas[bid], img_scale=img_scale_factor, view_id=view_id)
        ...
        #     [0, 0, 1]
        # ])
        # new_intrinsic = scaling_matrix @ intrinsic
