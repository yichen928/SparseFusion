...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            data_root=data_root,
            num_views=num_views,
            ann_file=data_root + '/nuscenes_infos_train_with_proj2d_wbox3dCL_vis_woRange.pkl',
...
load_from = 'checkpoints/LC_Implicitfusion_deepinteraction_voxel0075_R50_mask.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
