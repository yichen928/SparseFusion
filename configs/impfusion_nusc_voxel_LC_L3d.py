...
model = dict(
    ...
    pts_bbox_head=dict(
        type='ImplicitHeadL3D',
        with_pts=True,
        with_img=True,
        share_prediction_heads=False,
        pts_prediction=True,
        img_prediction=True,
        pts_smca=False,
        img_smca=False,
        ...
        num_pts_decoder_layers=2,
        num_img_decoder_layers=2,
        num_fusion_decoder_layers=2,
