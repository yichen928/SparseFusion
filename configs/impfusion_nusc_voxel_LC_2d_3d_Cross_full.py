...
train_pipeline = [
    ...
    dict(type='OurRandomAffine', scaling_ratio_range=(0.8, 1.2), flip_ratio=0.5),
    dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file=data_root + '/nuscenes_infos_train_with_proj2d_wDepth_woRange.pkl',
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_heatmap=dict(type='GaussianFocalLoss', reduction='mean', loss_weight=0.5),
        loss_heatmap_2d=dict(type='GaussianFocalLoss', reduction='mean', loss_weight=0.5), 
...
load_from = 'checkpoints/LC_Implicitfusion_voxel0075_R50_mask_coco.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
